...
- **User Features**:
    - **Two Grading Modes**: Quick Grade (2 photos: front + back, fast) and Deep Grade (4 photos: front + back + angled front + angled back, plus 4 auto-cropped corners = 8 images total, premium accuracy). Mode selector on Grade tab with guided step-by-step capture for Deep Grade.
