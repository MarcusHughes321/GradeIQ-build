...
const SLIDES: Slide[] = [
  {
    ...
    accentColor: "#8B5CF6",
    title: "What's New",
    subtitle: "Grade.IQ v1.0.29",
    description:
      "A stability and polish release — rock-solid grade reports on Android, plus pinch zoom and the filter slider now work perfectly in the image viewer.",
  },
  {
    id: "zoom",
    icon: "search",
    ...
    accentColor: "#06B6D4",
    title: "Zoom & Compare,\nFixed on Android",
    subtitle: "Image viewer upgrade",
    description:
      "Inspecting your card up close now works the way it should on Android — pinch to zoom, drag with two fingers, and slide the filter divider to compare.",
    bullets: [
      { icon: "expand-outline", text: "Pinch to zoom on report photos" },
      { icon: "swap-horizontal", text: "Drag the slider to compare filters" },
      { icon: "scan-outline", text: "Double-tap to reset the view" },
    ],
  },
  {
    id: "stability",
    ...
    accentColor: "#22C55E",
    title: "Sturdier Grade\nReports",
    subtitle: "Stability improvements",
    description:
      "Grade reports are now self-healing — if the AI ever returns an incomplete result, the app fills in the gaps automatically instead of stumbling.",
    bullets: [
      { icon: "construct-outline", text: "Incomplete results repair themselves" },
      { icon: "home-outline", text: "No more crashes opening the Home tab" },
      { icon: "cloud-done-outline", text: "Synced history restores cleanly" },
    ],
  },
  {
    id: "cta",
